...
* Blockiert GTM/GAM technisch, bis die Kategorie "analytics" aktiv zugestimmt wurde.
      ...
      translations: {
        de: {
          consentModal: {
            ...
            description: 'Notwendige Cookies sorgen für den technischen Betrieb dieser Website. Mit deiner Einwilligung nutzen wir zusätzlich Google Analytics und Meta Pixel, um zu verstehen wie die Seite genutzt wird.',
          ...
          preferencesModal: {
            ...
            sections: [
              ...
              },
              {
                ...
                description: 'Hilft uns zu verstehen, wie Besucher die Website nutzen. Dabei werden Daten an Google LLC (USA) übermittelt. Nur mit deiner Einwilligung aktiv.',
        ...
        en: {
          consentModal: {
            ...
            description: 'Necessary cookies keep this website running. With your consent, we also use Google Analytics and Meta Pixel to understand how visitors use the site.',
          ...
          preferencesModal: {
            ...
            sections: [
              ...
              },
              {
                ...
                description: 'Helps us understand how visitors use the website. Data is transmitted to Google LLC (USA). Only active with your consent.',
                linkedCategory: 'analytics',
                cookieTable: {
